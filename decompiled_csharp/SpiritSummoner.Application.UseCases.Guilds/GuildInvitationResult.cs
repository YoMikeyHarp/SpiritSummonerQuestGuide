...
public record GuildInvitationResult
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(GuildInvitationResult);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("GuildInvitationResult");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(GuildInvitationResult? other)
	{
