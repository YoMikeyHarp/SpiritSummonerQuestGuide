...
public class StartFriendBattleInitUseCase : IUseCase<StartFriendBattleInitRequest, BattleState>
{
	[CompilerGenerated]
	private sealed class _003CExecuteAsync_003Ed__7 : IAsyncStateMachine
	{
		...
		public StartFriendBattleInitRequest request;

		public StartFriendBattleInitUseCase _003C_003E4__this;
			...
			try
			{
				...
				try
				{
					...
					default:
						...
						{
							result = Result<BattleState>.FailureResult("Opponent player ID is required for Friend battles");
						}
					...
					case 2:
						try
						{
							...
							awaiter5 = _003C_003E4__this.LoadEquipmentForSprite(_003CbattleSprite_003E5__16, BattleMode.FriendBattle).GetAwaiter();
					...
					case 4:
						try
						{
							...
							awaiter3 = _003C_003E4__this.LoadEquipmentForSprite(_003CbattleSprite_003E5__21, BattleMode.FriendBattle).GetAwaiter();
						...
						else
						{
							if (_003CopponentBattleSprites_003E5__4.Count != 0)
							{
								...
								{
									BattleMode = BattleMode.FriendBattle,
								...
								awaiter2 = _003C_003E4__this._specialAbilityService.HandleBattleStartEffects(_003CbattleState_003E5__5, BattleMode.FriendBattle).GetAwaiter();
					...
					case 6:
						...
						awaiter = _003C_003E4__this._specialAbilityService.HandleSpiritEntersBattleEffects(_003CbattleState_003E5__5, BattleMode.FriendBattle).GetAwaiter();
				...
				catch (global::System.Exception ex)
				{
					...
					result = Result<BattleState>.FailureResult("Failed to initialize Friend battle: " + _003Cex_003E5__23.Message);
				}
			}
			catch (global::System.Exception ex)
			{
	...
	public StartFriendBattleInitUseCase(ISpiritRepository spiritRepository, IItemRepository itemRepository, IPlayerSpiritRepository playerSpiritRepository, IPlayerStateService playerStateService, IBattleCalculationService battleCalculationService, ISpecialAbilityService specialAbilityService)
	{
	...
	[DebuggerStepThrough]
	public async global::System.Threading.Tasks.Task<Result<BattleState>> ExecuteAsync(StartFriendBattleInitRequest request)
	{
		...
		try
		{
			...
			{
				return Result<BattleState>.FailureResult("Opponent player ID is required for Friend battles");
			}
			...
			try
			{
				while (enumerator3.MoveNext())
				{
					...
					if (baseSpirit2 != null)
					{
						...
						await LoadEquipmentForSprite(battleSprite2, BattleMode.FriendBattle);
			...
			try
			{
				while (enumerator4.MoveNext())
				{
					...
					if (baseSpirit != null)
					{
						...
						await LoadEquipmentForSprite(battleSprite, BattleMode.FriendBattle);
			...
			await _specialAbilityService.HandleBattleStartEffects(battleState, BattleMode.FriendBattle);
			await _specialAbilityService.HandleSpiritEntersBattleEffects(battleState, BattleMode.FriendBattle);
			return Result<BattleState>.SuccessResult(battleState);
		}
		catch (global::System.Exception ex2)
		{
			global::System.Exception ex = ex2;
			return Result<BattleState>.FailureResult("Failed to initialize Friend battle: " + ex.Message);
		}
	}
