...
public class SendChatMessageUseCase : IUseCase<SendChatMessageRequest, bool>
{
	[CompilerGenerated]
	private sealed class _003CExecuteAsync_003Ed__3 : IAsyncStateMachine
	{
		...
		public SendChatMessageUseCase _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				{
					result = Result<bool>.FailureResult("Conversation ID is required");
				}
				...
				try
				{
					...
					if (num != 0)
					{
						...
						awaiter = _003C_003E4__this._chatRepository.SendMessageAsync(request.ConversationId, _003Cmessage_003E5__2).GetAwaiter();
	...
	public SendChatMessageUseCase(IChatRepository chatRepository, IPlayerStateService playerState)
	{
	...
	[DebuggerStepThrough]
	public async global::System.Threading.Tasks.Task<Result<bool>> ExecuteAsync(SendChatMessageRequest request)
	{
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		//IL_000c: Unknown result type (might be due to invalid IL or missing references)
		if (string.IsNullOrEmpty(request.ConversationId))
		{
			return Result<bool>.FailureResult("Conversation ID is required");
		}
		...
		try
		{
			...
			return (await _chatRepository.SendMessageAsync(request.ConversationId, message)) ? Result<bool>.SuccessResult(data: true) : Result<bool>.FailureResult("Failed to send message");
		}
		catch (global::System.Exception ex)
		{
