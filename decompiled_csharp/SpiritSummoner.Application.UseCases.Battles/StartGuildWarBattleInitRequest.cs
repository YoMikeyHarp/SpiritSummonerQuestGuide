...
public record StartGuildWarBattleInitRequest(string PlayerId, List<string> PlayerSpiritIds, string OpponentPlayerId, List<string> OpponentSpiritIds)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(StartGuildWarBattleInitRequest);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("StartGuildWarBattleInitRequest");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(StartGuildWarBattleInitRequest? other)
	{
