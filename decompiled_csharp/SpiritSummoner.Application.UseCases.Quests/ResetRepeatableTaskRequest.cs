...
public record ResetRepeatableTaskRequest(string TaskId, string QuestId, string AreaId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(ResetRepeatableTaskRequest);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("ResetRepeatableTaskRequest");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(ResetRepeatableTaskRequest? other)
	{
