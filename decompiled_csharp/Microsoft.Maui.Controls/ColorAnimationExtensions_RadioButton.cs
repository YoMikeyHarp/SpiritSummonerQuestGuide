...
internal static class ColorAnimationExtensions_RadioButton
{
	public static global::System.Threading.Tasks.Task<bool> TextColorTo(this RadioButton element, Color color, uint rate = 16u, uint length = 250u, Easing? easing = null, CancellationToken token = default(CancellationToken))
	{
		...
		catch (ArgumentException val3)
		{
			...
			Trace.WriteLine($"{((MemberInfo)((global::System.Exception)(object)val4).GetType()).Name} thrown in {typeof(ColorAnimationExtensions_RadioButton).FullName}: {((global::System.Exception)(object)val4).Message}");
			animationCompletionSource.SetResult(false);
		}
		return animationCompletionSource.Task.WaitAsync(token);
		[CompilerGenerated]
		static Animation GetAlphaTransformAnimation(RadioButton element, float targetAlpha)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			RadioButton element2 = element;
		...
		[CompilerGenerated]
		static Animation GetBlueTransformAnimation(RadioButton element, float targetBlue)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			RadioButton element3 = element;
			return new Animation((Action<double>)delegate(double v)
			{
		...
		[CompilerGenerated]
		static Animation GetGreenTransformAnimation(RadioButton element, float targetGreen)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			RadioButton element4 = element;
			return new Animation((Action<double>)delegate(double v)
			{
		...
		[CompilerGenerated]
		static Animation GetRedTransformAnimation(RadioButton element, float targetRed)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			RadioButton element5 = element;
			return new Animation((Action<double>)delegate(double v)
			{
