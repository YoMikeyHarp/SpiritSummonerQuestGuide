...
public record EvolveSpiritRequest(string SpiritId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(EvolveSpiritRequest);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("EvolveSpiritRequest");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(EvolveSpiritRequest? other)
	{
