...
public record ExecuteQuestTaskHoldRequest(string TaskId, string QuestId, string AreaId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(ExecuteQuestTaskHoldRequest);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("ExecuteQuestTaskHoldRequest");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(ExecuteQuestTaskHoldRequest? other)
	{
