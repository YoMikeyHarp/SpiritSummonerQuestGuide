...
public record DisbandGuildRequest(string PlayerId, string GuildId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(DisbandGuildRequest);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("DisbandGuildRequest");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(DisbandGuildRequest? other)
	{
