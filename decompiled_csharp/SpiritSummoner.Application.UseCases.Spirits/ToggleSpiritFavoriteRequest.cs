...
public record ToggleSpiritFavoriteRequest(string SpiritId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(ToggleSpiritFavoriteRequest);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("ToggleSpiritFavoriteRequest");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(ToggleSpiritFavoriteRequest? other)
	{
