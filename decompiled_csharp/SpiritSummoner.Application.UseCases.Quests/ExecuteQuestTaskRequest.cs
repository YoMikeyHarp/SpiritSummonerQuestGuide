...
public record ExecuteQuestTaskRequest(string TaskId, string QuestId, string AreaId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(ExecuteQuestTaskRequest);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("ExecuteQuestTaskRequest");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(ExecuteQuestTaskRequest? other)
	{
