...
public class EditGearSheetViewModel : ObservableObject
{
	[CompilerGenerated]
	private sealed class _003C_003Ec__DisplayClass27_0
	{
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					try
					{
						...
						awaiter = _003C_003E4__this._003C_003E4__this._navigationService.ShowAlertAsync("Error", _003Cresult_003E5__1.ErrorMessage ?? "Failed to load gear items").GetAwaiter();
					...
					{
						_003Cex_003E5__3 = ex;
						Console.WriteLine("Error loading available gear: " + _003Cex_003E5__3.Message);
		...
		public EditGearSheetViewModel _003C_003E4__this;
	...
	private sealed class _003CCancel_003Ed__30 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				if (num != 0)
				{
					_003C_003E4__this._bottomSheetService.SetResult(_003C_003E4__this._sheetId, GearResult.Cancel);
	...
	private sealed class _003CConfirm_003Ed__31 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				{
					_003C_003E4__this._bottomSheetService.SetResult(_003C_003E4__this._sheetId, new GearResult
					{
						Success = true,
	...
	private sealed class _003CGoToShop_003Ed__32 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				if (num != 0)
				{
					_003C_003E4__this._bottomSheetService.SetResult(_003C_003E4__this._sheetId, GearResult.GoToShop);
					awaiter = _003C_003E4__this._bottomSheetService.DismissAsync(_003C_003E4__this._sheet).GetAwaiter();
					if (!((TaskAwaiter)(ref awaiter)).IsCompleted)
					{
						num = (_003C_003E1__state = 0);
	...
	private sealed class _003CRemoveItem_003Ed__33 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				((ObservableObject)_003C_003E4__this).OnPropertyChanged("CurrentGear");
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				default:
					...
					{
						awaiter4 = _003C_003E4__this._navigationService.ShowConfirmationAsync("Unequip Gear", "Are you sure? The gear will be lost if unequipped.").GetAwaiter();
				...
				case 3:
					...
					{
						awaiter2 = _003C_003E4__this._navigationService.ShowAlertAsync("Error", _003Cresult_003E5__2.ErrorMessage ?? "Failed to unequip gear").GetAwaiter();
					...
					{
						awaiter3 = _003C_003E4__this._unequipItemUseCase.ExecuteAsync(new UnequipItemRequest(_003C_003E4__this._playerSpiritId, EquipmentType.Gear)).GetAwaiter();
	...
	private readonly string? _currentGearId;
	...
	private ItemModel? _currentGearItem;
	...
	public bool HasUnsavedChanges => _newItemId != _currentGearId;

	public bool IsItemSelected => !string.IsNullOrEmpty(_newItemId) && _newItemId != CurrentGear?.Id;

	public bool HasItem => !string.IsNullOrEmpty(_currentGearId);

	public ItemModel CurrentGear => _currentGearItem ?? new ItemModel
	{
		Name = "",
		Description = ""
	};
	...
	public EditGearSheetViewModel(SpiritCardModel playerSpirit, string sheetId, IBottomSheetService bottomSheetService, INavigationService navigationService, GetEquippableItemsUseCase getEquippableItemsUseCase, UnequipItemUseCase unequipItemUseCase)
	{
		...
		_sheetId = sheetId;
		_currentGearId = playerSpirit.GearId;
	...
	private void LoadAvailableItems()
	{
		...
		try
		{
			...
			CollectionsMarshal.AsSpan<ItemType>(obj)[0] = ItemType.gear;
