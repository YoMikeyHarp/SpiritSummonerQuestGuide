...
public record GetShopItemDetailsRequest(string ItemId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(GetShopItemDetailsRequest);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("GetShopItemDetailsRequest");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(GetShopItemDetailsRequest? other)
	{
