...
internal static class ColorAnimationExtensions_TimePicker
{
	public static global::System.Threading.Tasks.Task<bool> TextColorTo(this TimePicker element, Color color, uint rate = 16u, uint length = 250u, Easing? easing = null, CancellationToken token = default(CancellationToken))
	{
		...
		catch (ArgumentException val3)
		{
			...
			Trace.WriteLine($"{((MemberInfo)((global::System.Exception)(object)val4).GetType()).Name} thrown in {typeof(ColorAnimationExtensions_TimePicker).FullName}: {((global::System.Exception)(object)val4).Message}");
			animationCompletionSource.SetResult(false);
		}
		return animationCompletionSource.Task.WaitAsync(token);
		[CompilerGenerated]
		static Animation GetAlphaTransformAnimation(TimePicker element, float targetAlpha)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			TimePicker element2 = element;
		...
		[CompilerGenerated]
		static Animation GetBlueTransformAnimation(TimePicker element, float targetBlue)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			TimePicker element3 = element;
			return new Animation((Action<double>)delegate(double v)
			{
		...
		[CompilerGenerated]
		static Animation GetGreenTransformAnimation(TimePicker element, float targetGreen)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			TimePicker element4 = element;
			return new Animation((Action<double>)delegate(double v)
			{
		...
		[CompilerGenerated]
		static Animation GetRedTransformAnimation(TimePicker element, float targetRed)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			TimePicker element5 = element;
			return new Animation((Action<double>)delegate(double v)
			{
