...
public record SetPartnerSpiritResponse(string SpiritId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(SetPartnerSpiritResponse);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("SetPartnerSpiritResponse");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(SetPartnerSpiritResponse? other)
	{
