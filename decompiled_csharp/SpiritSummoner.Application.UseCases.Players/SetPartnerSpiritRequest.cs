...
public record SetPartnerSpiritRequest(string SpiritId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(SetPartnerSpiritRequest);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("SetPartnerSpiritRequest");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(SetPartnerSpiritRequest? other)
	{
