...
public record BattleOpponentPresentationModel
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(BattleOpponentPresentationModel);
		}
	}
	...
	public string TitleDisplay => Title ?? "Unranked";

	public static BattleOpponentPresentationModel FromDTO(BattleOpponentDTO dto)
	{
		return new BattleOpponentPresentationModel
		{
			...
			ActiveSquadSpiritIds = dto.ActiveSquadSpiritIds,
			OpponentSpirits = dto.OpponentSpirits
		};
	}
	...
	public override string ToString()
	{
		...
		val.Append("BattleOpponentPresentationModel");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	protected virtual bool PrintMembers(StringBuilder builder)
	{
		...
		builder.Append(", TitleDisplay = ");
		builder.Append((object)TitleDisplay);
		return true;
	}

	[CompilerGenerated]
	public virtual bool Equals(BattleOpponentPresentationModel? other)
	{
