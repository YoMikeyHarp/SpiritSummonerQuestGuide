...
internal static class ColorAnimationExtensions_Button
{
	public static global::System.Threading.Tasks.Task<bool> TextColorTo(this Button element, Color color, uint rate = 16u, uint length = 250u, Easing? easing = null, CancellationToken token = default(CancellationToken))
	{
		...
		catch (ArgumentException val3)
		{
			...
			Trace.WriteLine($"{((MemberInfo)((global::System.Exception)(object)val4).GetType()).Name} thrown in {typeof(ColorAnimationExtensions_Button).FullName}: {((global::System.Exception)(object)val4).Message}");
			animationCompletionSource.SetResult(false);
		}
		return animationCompletionSource.Task.WaitAsync(token);
		[CompilerGenerated]
		static Animation GetAlphaTransformAnimation(Button element, float targetAlpha)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			Button element2 = element;
		...
		[CompilerGenerated]
		static Animation GetBlueTransformAnimation(Button element, float targetBlue)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			Button element3 = element;
			return new Animation((Action<double>)delegate(double v)
			{
		...
		[CompilerGenerated]
		static Animation GetGreenTransformAnimation(Button element, float targetGreen)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			Button element4 = element;
			return new Animation((Action<double>)delegate(double v)
			{
		...
		[CompilerGenerated]
		static Animation GetRedTransformAnimation(Button element, float targetRed)
		{
			//IL_002e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0034: Expected O, but got Unknown
			Button element5 = element;
			return new Animation((Action<double>)delegate(double v)
			{
