...
public record AddSpiritToSquadResponse(int PositionInSquad, string SpiritId)
{
	[CompilerGenerated]
	protected virtual global::System.Type EqualityContract
	{
		...
		get
		{
			return typeof(AddSpiritToSquadResponse);
		}
	}
	...
	public override string ToString()
	{
		...
		val.Append("AddSpiritToSquadResponse");
		val.Append(" { ");
		if (PrintMembers(val))
		{
			val.Append(' ');
	...
	[CompilerGenerated]
	public virtual bool Equals(AddSpiritToSquadResponse? other)
	{
