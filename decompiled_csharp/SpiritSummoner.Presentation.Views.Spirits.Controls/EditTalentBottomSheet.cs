...
namespace SpiritSummoner.Presentation.Views.Spirits.Controls;

[XamlFilePath("Presentation\\Views\\BottomSheets\\SpiritSheets\\EditTalentBottomSheet.xaml")]
public class EditTalentBottomSheet : BottomSheet
{
	[CompilerGenerated]
	private sealed class _003COnCancelTapped_003Ed__2 : IAsyncStateMachine
	{
		...
		public EditTalentBottomSheet _003C_003E4__this;

		private EditTalentSheetViewModel _003Cvm_003E5__1;
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				_003Cvm_003E5__1 = bindingContext as EditTalentSheetViewModel;
	...
	public EditTalentBottomSheet(IBottomSheetService sheetService)
	{
		InitializeComponent();
	...
	{
		Extensions.LoadFromXaml<EditTalentBottomSheet>(this, typeof(EditTalentBottomSheet));
	}
}
